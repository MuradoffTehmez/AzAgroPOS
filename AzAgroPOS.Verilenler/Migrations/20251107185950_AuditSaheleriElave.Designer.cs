...
namespace AzAgroPOS.Verilenler.Migrations
{
    ...
    [Migration("20251107185950_AuditSaheleriElave")]
    partial class AuditSaheleriElave
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AzAgroPOS.Varliglar.AlisSened", b =>
                {
                    ...
                    b.Property<int?>("DeyisdirenIstifadeciId")
                        .HasColumnType("int");

                    b.Property<DateTime?>("DeyisdirilmeTarixi")
                    ...
                    b.Property<int?>("YaradanIstifadeciId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("AzAgroPOS.Varliglar.BonusQeydi", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("AzAgroPOS.Varliglar.Brend", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            YaradilmaTarixi = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified)
                        },
                        new
                        {
                            Id = 2,
            ...
            modelBuilder.Entity("AzAgroPOS.Varliglar.EmekHaqqi", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<decimal>("DigerTutulmalar")
                        .HasColumnType("decimal(18, 2)");

                    b.Property<string>("Dovr")
                        .IsRequired()
                        .HasColumnType("nvarchar(450)");

                    b.Property<decimal>("ElaveOdenisler")
                        .HasColumnType("decimal(18, 2)");
                    ...
                    b.Property<decimal>("IcazeTutulmasi")
                        .HasColumnType("decimal(18, 2)");
            ...
            modelBuilder.Entity("AzAgroPOS.Varliglar.GirisLoquKaydi", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<DateTime>("CehdTarixi")
                        .HasColumnType("datetime2");
                    ...
                    b.Property<bool>("Ugurlu")
                        .HasColumnType("bit");

                    b.Property<string>("UgursuzluqSebebi")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("AzAgroPOS.Varliglar.Istifadeci", b =>
                {
                    ...
                    b.Property<bool>("HesabAktivdir")
                        .HasColumnType("bit");

                    b.Property<DateTime?>("HesabKilidlenmeTarixi")
                        .HasColumnType("datetime2");
                    ...
                    b.Property<DateTime?>("SonGirisTarixi")
                        .HasColumnType("datetime2");

                    b.Property<DateTime?>("SonSifreDeyismeTarixi")
                        .HasColumnType("datetime2");
                    ...
                    b.Property<int>("UgursuzGirisCehdi")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("AzAgroPOS.Varliglar.IstifadeciSessiyasi", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<DateTime?>("BitməTarixi")
                        .HasColumnType("datetime2");
                    ...
                    b.Property<DateTime>("SonAktivlikTarixi")
                        .HasColumnType("datetime2");
            ...
            modelBuilder.Entity("AzAgroPOS.Varliglar.MusteriBonus", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<decimal>("IstifadeEdilmisBal")
                        .HasColumnType("decimal(18, 2)");

                    b.Property<int>("MusteriId")
                        .HasColumnType("int");

                    b.Property<int>("Seviyye")
                        .HasColumnType("int");
                    ...
                    b.Property<DateTime?>("SonBalIstifadeTarixi")
                        .HasColumnType("datetime2");

                    b.Property<DateTime?>("SonBalQazanmaTarixi")
                        .HasColumnType("datetime2");

                    b.Property<decimal>("ToplamBal")
                        .HasColumnType("decimal(18, 2)");
            ...
            modelBuilder.Entity("AzAgroPOS.Varliglar.StokHareketi", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("AzAgroPOS.Varliglar.BonusQeydi", b =>
                {
                    b.HasOne("AzAgroPOS.Varliglar.MusteriBonus", "MusteriBonus")
                        .WithMany("BonusQeydleri")
                        .HasForeignKey("MusteriBonusId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("AzAgroPOS.Varliglar.MusteriBonus", b =>
                {
                    b.HasOne("AzAgroPOS.Varliglar.Musteri", "Musteri")
                        .WithOne()
                        .HasForeignKey("AzAgroPOS.Varliglar.MusteriBonus", "MusteriId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("AzAgroPOS.Varliglar.Isci", b =>
                {
                    b.Navigation("EmekHaqqiQeydleri");
