...
public partial class IstifadeciIdareetmeFormu : BazaForm, IIstifadeciView
{
    ...
    public void IstifadecileriGoster(List<IstifadeciDto> istifadeciler) => dgvIstifadeciler.DataSource = istifadeciler;
    ...
    public void MesajGoster(string mesaj, bool xetadir = false) => MessageBox.Show(mesaj, xetadir ? "Xəta" : "Məlumat", MessageBoxButtons.OK, xetadir ? MessageBoxIcon.Error : MessageBoxIcon.Information);
