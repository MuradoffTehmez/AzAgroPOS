...
namespace AzAgroPOS.BLL
{
    ...
    public class MehsulBLL
    {
        ...
        /// <summary>
        /// Yeni və unikal bir barkod yaradır və qaytarır.
        /// </summary>
        public string GenerateNewUniqueBarcode()
        {
            string newBarcode;
            int nextId = _dal.GetLastProductId() + 1;
            do
            {
                newBarcode = $"AZP-{nextId:D6}";
                nextId++;
            }
            while (_dal.BarcodeExists(newBarcode));
        ...
        public bool Add(Mehsul mehsul, Istifadeci emeliyyatiEden, out string message)
        {
            ...
            {
                message = "Məhsul barkodu boş ola bilməz.";
                return false;
            }
            ...
            if (_dal.BarcodeExists(mehsul.Barkod))
            {
                message = $"'{mehsul.Barkod}' barkodu artıq başqa bir məhsul üçün istifadə olunur.";
                return false;
            }
